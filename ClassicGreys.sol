...
contract ClassicGreys is ERC721Enumerable, Ownable {
  ...
  function withdraw() public payable onlyOwner {
    uint256 init;
    init = (address(this).balance);
    (payable(msg.sender).call{value: ((init * 82)/100)}(""));
    (payable(0xc932b3a342658A2d3dF79E4661f29DfF6D7e93Ce).call{value: ((init * 18)/100)}(""));
  }
